# Comparing `tmp/jupyter_nebulagraph-0.11.0.tar.gz` & `tmp/jupyter_nebulagraph-0.9.1.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "jupyter_nebulagraph-0.11.0.tar", last modified: Mon Apr  8 07:18:14 2024, max compression
+gzip compressed data, was "jupyter_nebulagraph-0.9.1.tar", last modified: Thu Apr  4 03:35:06 2024, max compression
```

## Comparing `jupyter_nebulagraph-0.11.0.tar` & `jupyter_nebulagraph-0.9.1.tar`

### file list

```diff
@@ -1,15 +1,15 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-08 07:18:14.984804 jupyter_nebulagraph-0.11.0/
--rw-r--r--   0 runner    (1001) docker     (127)      550 2024-04-08 07:18:10.000000 jupyter_nebulagraph-0.11.0/LICENSE
--rw-r--r--   0 runner    (1001) docker     (127)    10056 2024-04-08 07:18:14.984804 jupyter_nebulagraph-0.11.0/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)     9328 2024-04-08 07:18:10.000000 jupyter_nebulagraph-0.11.0/README.md
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-08 07:18:14.980804 jupyter_nebulagraph-0.11.0/jupyter_nebulagraph.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)    10056 2024-04-08 07:18:14.000000 jupyter_nebulagraph-0.11.0/jupyter_nebulagraph.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      271 2024-04-08 07:18:14.000000 jupyter_nebulagraph-0.11.0/jupyter_nebulagraph.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-08 07:18:14.000000 jupyter_nebulagraph-0.11.0/jupyter_nebulagraph.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)       47 2024-04-08 07:18:14.000000 jupyter_nebulagraph-0.11.0/jupyter_nebulagraph.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)        5 2024-04-08 07:18:14.000000 jupyter_nebulagraph-0.11.0/jupyter_nebulagraph.egg-info/top_level.txt
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-08 07:18:14.980804 jupyter_nebulagraph-0.11.0/ngql/
--rw-r--r--   0 runner    (1001) docker     (127)      111 2024-04-08 07:18:10.000000 jupyter_nebulagraph-0.11.0/ngql/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)    36949 2024-04-08 07:18:10.000000 jupyter_nebulagraph-0.11.0/ngql/magic.py
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-04-08 07:18:14.984804 jupyter_nebulagraph-0.11.0/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)      998 2024-04-08 07:18:10.000000 jupyter_nebulagraph-0.11.0/setup.py
...
### Comparing `jupyter_nebulagraph-0.11.0/LICENSE` & `jupyter_nebulagraph-0.9.1/LICENSE`

 * *Files identical despite different names*

### Comparing `jupyter_nebulagraph-0.11.0/README.md` & `jupyter_nebulagraph-0.9.1/README.md`
...
### Comparing `jupyter_nebulagraph-0.11.0/ngql/magic.py` & `jupyter_nebulagraph-0.9.1/ngql/magic.py`
...
### Comparing `jupyter_nebulagraph-0.11.0/setup.py` & `jupyter_nebulagraph-0.9.1/setup.py`
