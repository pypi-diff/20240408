# Comparing `tmp/cycparser-1.2.82.tar.gz` & `tmp/cycparser-1.2.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "cycparser-1.2.82.tar", max compression
+gzip compressed data, was "cycparser-1.2.9.tar", max compression
```

## Comparing `cycparser-1.2.82.tar` & `cycparser-1.2.9.tar`

### file list

```diff
@@ -1,27 +1,27 @@
--rw-r--r--   0        0        0    35079 2024-04-08 01:03:54.298226 cycparser-1.2.82/LICENSE
--rw-r--r--   0        0        0     1661 2024-04-08 01:03:54.299226 cycparser-1.2.82/pyproject.toml
--rw-r--r--   0        0        0     3512 2024-04-08 01:03:54.299226 cycparser-1.2.82/src/cycparser/__init__.py
--rw-r--r--   0        0        0     2827 2024-04-08 01:03:54.299226 cycparser-1.2.82/src/cycparser/data.py
--rw-r--r--   0        0        0     6585 2024-04-08 01:03:54.299226 cycparser-1.2.82/src/cycparser/defaults.py
--rw-r--r--   0        0        0     1994 2024-04-08 01:03:54.299226 cycparser-1.2.82/src/cycparser/parsing/__init__.py
--rw-r--r--   0        0        0     3434 2024-04-08 01:03:54.299226 cycparser-1.2.82/src/cycparser/parsing/compounds.py
--rw-r--r--   0        0        0     2545 2024-04-08 01:03:54.299226 cycparser-1.2.82/src/cycparser/parsing/enzymes.py
--rw-r--r--   0        0        0     2753 2024-04-08 01:03:54.299226 cycparser-1.2.82/src/cycparser/parsing/monomer_annotation.py
--rw-r--r--   0        0        0      502 2024-04-08 01:03:54.299226 cycparser-1.2.82/src/cycparser/parsing/monomer_sequences.py
--rw-r--r--   0        0        0     1390 2024-04-08 01:03:54.299226 cycparser-1.2.82/src/cycparser/parsing/protein_complexes.py
--rw-r--r--   0        0        0     6825 2024-04-08 01:03:54.299226 cycparser-1.2.82/src/cycparser/parsing/reactions.py
--rw-r--r--   0        0        0     2044 2024-04-08 01:03:54.300226 cycparser-1.2.82/src/cycparser/parsing/shared.py
--rw-r--r--   0        0        0        0 2024-04-08 01:03:54.324226 cycparser-1.2.82/src/cycparser/py.typed
--rw-r--r--   0        0        0      954 2024-04-08 01:03:54.300226 cycparser-1.2.82/src/cycparser/repairing/__init__.py
--rw-r--r--   0        0        0      289 2024-04-08 01:03:54.300226 cycparser-1.2.82/src/cycparser/repairing/fix_add_important_cpds.py
--rw-r--r--   0        0        0     8626 2024-04-08 01:03:54.300226 cycparser-1.2.82/src/cycparser/repairing/fix_create_compartment_variants.py
--rw-r--r--   0        0        0     2202 2024-04-08 01:03:54.300226 cycparser-1.2.82/src/cycparser/repairing/fix_create_reaction_variants.py
--rw-r--r--   0        0        0      455 2024-04-08 01:03:54.300226 cycparser-1.2.82/src/cycparser/repairing/fix_filter_garbage.py
--rw-r--r--   0        0        0     1144 2024-04-08 01:03:54.300226 cycparser-1.2.82/src/cycparser/repairing/fix_get_gpr_association.py
--rw-r--r--   0        0        0      520 2024-04-08 01:03:54.300226 cycparser-1.2.82/src/cycparser/repairing/fix_get_highest_compound_type.py
--rw-r--r--   0        0        0      525 2024-04-08 01:03:54.300226 cycparser-1.2.82/src/cycparser/repairing/fix_get_kinetic_data.py
--rw-r--r--   0        0        0     1170 2024-04-08 01:03:54.300226 cycparser-1.2.82/src/cycparser/repairing/fix_set_reaction_stoichiometry.py
--rw-r--r--   0        0        0     1778 2024-04-08 01:03:54.300226 cycparser-1.2.82/src/cycparser/repairing/fix_unify_reaction_direction.py
--rw-r--r--   0        0        0     2416 2024-04-08 01:03:54.300226 cycparser-1.2.82/src/cycparser/utils.py
--rw-r--r--   0        0        0      717 1970-01-01 00:00:00.000000 cycparser-1.2.82/setup.py
--rw-r--r--   0        0        0      452 1970-01-01 00:00:00.000000 cycparser-1.2.82/PKG-INFO
...
### Comparing `cycparser-1.2.82/LICENSE` & `cycparser-1.2.9/LICENSE`

 * *Files identical despite different names*

### Comparing `cycparser-1.2.82/pyproject.toml` & `cycparser-1.2.9/pyproject.toml`
...
### Comparing `cycparser-1.2.82/src/cycparser/__init__.py` & `cycparser-1.2.9/src/cycparser/__init__.py`
...
### Comparing `cycparser-1.2.82/src/cycparser/data.py` & `cycparser-1.2.9/src/cycparser/data.py`
...
### Comparing `cycparser-1.2.82/src/cycparser/defaults.py` & `cycparser-1.2.9/src/cycparser/defaults.py`
...
### Comparing `cycparser-1.2.82/src/cycparser/parsing/__init__.py` & `cycparser-1.2.9/src/cycparser/parsing/__init__.py`
...
### Comparing `cycparser-1.2.82/src/cycparser/parsing/compounds.py` & `cycparser-1.2.9/src/cycparser/parsing/compounds.py`

 * *Files identical despite different names*

### Comparing `cycparser-1.2.82/src/cycparser/parsing/enzymes.py` & `cycparser-1.2.9/src/cycparser/parsing/enzymes.py`
...
### Comparing `cycparser-1.2.82/src/cycparser/parsing/monomer_annotation.py` & `cycparser-1.2.9/src/cycparser/parsing/monomer_annotation.py`
...
### Comparing `cycparser-1.2.82/src/cycparser/parsing/protein_complexes.py` & `cycparser-1.2.9/src/cycparser/parsing/protein_complexes.py`
...
### Comparing `cycparser-1.2.82/src/cycparser/parsing/reactions.py` & `cycparser-1.2.9/src/cycparser/parsing/reactions.py`
...
### Comparing `cycparser-1.2.82/src/cycparser/parsing/shared.py` & `cycparser-1.2.9/src/cycparser/parsing/shared.py`
...
### Comparing `cycparser-1.2.82/src/cycparser/repairing/__init__.py` & `cycparser-1.2.9/src/cycparser/repairing/__init__.py`
...
### Comparing `cycparser-1.2.82/src/cycparser/repairing/fix_create_compartment_variants.py` & `cycparser-1.2.9/src/cycparser/repairing/fix_create_compartment_variants.py`
...
### Comparing `cycparser-1.2.82/src/cycparser/repairing/fix_create_reaction_variants.py` & `cycparser-1.2.9/src/cycparser/repairing/fix_create_reaction_variants.py`
...
### Comparing `cycparser-1.2.82/src/cycparser/repairing/fix_get_gpr_association.py` & `cycparser-1.2.9/src/cycparser/repairing/fix_get_gpr_association.py`

 * *Files identical despite different names*

### Comparing `cycparser-1.2.82/src/cycparser/repairing/fix_get_highest_compound_type.py` & `cycparser-1.2.9/src/cycparser/repairing/fix_get_highest_compound_type.py`

 * *Files identical despite different names*

### Comparing `cycparser-1.2.82/src/cycparser/repairing/fix_get_kinetic_data.py` & `cycparser-1.2.9/src/cycparser/repairing/fix_get_kinetic_data.py`

 * *Files identical despite different names*

### Comparing `cycparser-1.2.82/src/cycparser/repairing/fix_set_reaction_stoichiometry.py` & `cycparser-1.2.9/src/cycparser/repairing/fix_set_reaction_stoichiometry.py`
...
### Comparing `cycparser-1.2.82/src/cycparser/repairing/fix_unify_reaction_direction.py` & `cycparser-1.2.9/src/cycparser/repairing/fix_unify_reaction_direction.py`
...
### Comparing `cycparser-1.2.82/src/cycparser/utils.py` & `cycparser-1.2.9/src/cycparser/utils.py`
...
### Comparing `cycparser-1.2.82/setup.py` & `cycparser-1.2.9/setup.py`
