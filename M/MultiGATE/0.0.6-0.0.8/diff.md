# Comparing `tmp/MultiGATE-0.0.6.tar.gz` & `tmp/MultiGATE-0.0.8.tar.gz`
...
## Comparing `MultiGATE-0.0.6.tar` & `MultiGATE-0.0.8.tar`
...
### Comparing `MultiGATE-0.0.6/LICENSE` & `MultiGATE-0.0.8/LICENSE`

 * *Files identical despite different names*

### Comparing `MultiGATE-0.0.6/MultiGATE/MultiGATE.egg-info/PKG-INFO` & `MultiGATE-0.0.8/MultiGATE/MultiGATE.egg-info/PKG-INFO`
...
### Comparing `MultiGATE-0.0.6/PKG-INFO` & `MultiGATE-0.0.8/PKG-INFO`
...
### Comparing `MultiGATE-0.0.6/setup.py` & `MultiGATE-0.0.8/setup.py`
