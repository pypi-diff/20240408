# Comparing `tmp/gauge-api-steps-0.16.tar.gz` & `tmp/gauge-api-steps-0.9.tar.gz`

## filetype from file(1)

```diff
@@ -1 +1 @@
-gzip compressed data, was "gauge-api-steps-0.16.tar", last modified: Mon Apr  8 15:17:42 2024, max compression
+gzip compressed data, was "gauge-api-steps-0.9.tar", last modified: Mon Jul 31 14:43:38 2023, max compression
```

## Comparing `gauge-api-steps-0.16.tar` & `gauge-api-steps-0.9.tar`

### file list

```diff
@@ -1,19 +1,17 @@
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-08 15:17:42.601371 gauge-api-steps-0.16/
--rw-r--r--   0 runner    (1001) docker     (127)     1088 2024-04-08 15:17:20.000000 gauge-api-steps-0.16/LICENCE
--rw-r--r--   0 runner    (1001) docker     (127)     6384 2024-04-08 15:17:42.601371 gauge-api-steps-0.16/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)     5871 2024-04-08 15:17:20.000000 gauge-api-steps-0.16/README.md
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-08 15:17:42.601371 gauge-api-steps-0.16/gauge_api_steps/
--rw-r--r--   0 runner    (1001) docker     (127)       63 2024-04-08 15:17:20.000000 gauge-api-steps-0.16/gauge_api_steps/__init__.py
--rw-r--r--   0 runner    (1001) docker     (127)    18774 2024-04-08 15:17:20.000000 gauge-api-steps-0.16/gauge_api_steps/api_steps.py
--rw-r--r--   0 runner    (1001) docker     (127)      379 2024-04-08 15:17:20.000000 gauge-api-steps-0.16/gauge_api_steps/file_util.py
--rw-r--r--   0 runner    (1001) docker     (127)     3595 2024-04-08 15:17:20.000000 gauge-api-steps-0.16/gauge_api_steps/substitute.py
-drwxr-xr-x   0 runner    (1001) docker     (127)        0 2024-04-08 15:17:42.601371 gauge-api-steps-0.16/gauge_api_steps.egg-info/
--rw-r--r--   0 runner    (1001) docker     (127)     6384 2024-04-08 15:17:42.000000 gauge-api-steps-0.16/gauge_api_steps.egg-info/PKG-INFO
--rw-r--r--   0 runner    (1001) docker     (127)      389 2024-04-08 15:17:42.000000 gauge-api-steps-0.16/gauge_api_steps.egg-info/SOURCES.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-08 15:17:42.000000 gauge-api-steps-0.16/gauge_api_steps.egg-info/dependency_links.txt
--rw-r--r--   0 runner    (1001) docker     (127)        1 2024-04-08 15:17:42.000000 gauge-api-steps-0.16/gauge_api_steps.egg-info/not-zip-safe
--rw-r--r--   0 runner    (1001) docker     (127)       48 2024-04-08 15:17:42.000000 gauge-api-steps-0.16/gauge_api_steps.egg-info/requires.txt
--rw-r--r--   0 runner    (1001) docker     (127)       16 2024-04-08 15:17:42.000000 gauge-api-steps-0.16/gauge_api_steps.egg-info/top_level.txt
--rw-r--r--   0 runner    (1001) docker     (127)       48 2024-04-08 15:17:20.000000 gauge-api-steps-0.16/pyproject.toml
--rw-r--r--   0 runner    (1001) docker     (127)       38 2024-04-08 15:17:42.601371 gauge-api-steps-0.16/setup.cfg
--rw-r--r--   0 runner    (1001) docker     (127)      857 2024-04-08 15:17:20.000000 gauge-api-steps-0.16/setup.py
...
### Comparing `gauge-api-steps-0.16/LICENCE` & `gauge-api-steps-0.9/LICENCE`

 * *Files identical despite different names*

### Comparing `gauge-api-steps-0.16/gauge_api_steps/api_steps.py` & `gauge-api-steps-0.9/gauge_api_steps/api_steps.py`
...
### Comparing `gauge-api-steps-0.16/setup.py` & `gauge-api-steps-0.9/setup.py`
