# Comparing `tmp/smaht_submitr-0.8.0.1b6.tar.gz` & `tmp/smaht_submitr-0.8.0.1b7.tar.gz`
...
### Comparing `smaht_submitr-0.8.0.1b6/pyproject.toml` & `smaht_submitr-0.8.0.1b7/pyproject.toml`
