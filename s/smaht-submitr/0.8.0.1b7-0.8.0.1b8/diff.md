# Comparing `tmp/smaht_submitr-0.8.0.1b7.tar.gz` & `tmp/smaht_submitr-0.8.0.1b8.tar.gz`
...
### Comparing `smaht_submitr-0.8.0.1b7/pyproject.toml` & `smaht_submitr-0.8.0.1b8/pyproject.toml`
