# Comparing `tmp/spice_rack-0.5.1.tar.gz` & `tmp/spice_rack-0.6.0.tar.gz`
...
### Comparing `spice_rack-0.5.1/src/spice_rack/_bases/_root.py` & `spice_rack-0.6.0/src/spice_rack/_bases/_root.py`
