# Comparing `tmp/bs_logic-0.0.7.tar.gz` & `tmp/bs_logic-0.0.8.tar.gz`
...
## Comparing `bs_logic-0.0.7.tar` & `bs_logic-0.0.8.tar`
...
### Comparing `bs_logic-0.0.7/bs_logic/parser.py` & `bs_logic-0.0.8/bs_logic/parser.py`

 * *Files identical despite different names*

### Comparing `bs_logic-0.0.7/setup.py` & `bs_logic-0.0.8/setup.py`
