# Comparing `tmp/bec_client-1.22.2.tar.gz` & `tmp/bec_client-1.23.0.tar.gz`
...
### Comparing `bec_client-1.22.2/bec_client/beamline_mixin.py` & `bec_client-1.23.0/bec_client/beamline_mixin.py`
